    ...
    const postagem = [
        {
            ...
            iconeBaixo: "bookmark-outline", Curtido: "respondeai", Npessoas: Number(3),fotoM:"./assets/img/respondeai.svg"
        },
        {
        nome: "meowed2", fotoP: "./assets/img/meowed.svg", mais: " ellipsis-horizontal",
        fotoG: "./assets/img/gato-telefone.svg", icone1: "heart-outline", icone2: "chatbubble-outline", icone3: "paper-plane-outline",
        iconeBaixo: "bookmark-outline", Curtido: "respondeai", Npessoas: Number(2),fotoM:"./assets/img/respondeai.svg"},
        {
            nome: "meowed3", fotoP: "./assets/img/meowed.svg", mais: " ellipsis-horizontal",
            fotoG: "./assets/img/gato-telefone.svg", icone1: "heart-outline", icone2: "chatbubble-outline", icone3: "paper-plane-outline",
            iconeBaixo: "bookmark-outline", Curtido: "respondeai", Npessoas:Number(7) ,fotoM:"./assets/img/respondeai.svg"}
